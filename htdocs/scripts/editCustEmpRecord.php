...
if ($edit_value_selection = "cust_id"){
    $query = "UPDATE `order` SET $edit_value_selection = $edit_value WHERE order_num=$order_id";
    echo "<br>$edit_value_selection<br>";
}
elseif ($edit_value_selection = "emp_id"){
    $query = "UPDATE `order` SET $edit_value_selection = $edit_value WHERE order_num=$order_id";
    echo "<br>$edit_value_selection<br>";
}
else{
